    ...
    <section id="work" className="bg-neutral-950 text-neutral-200">
      <div className="mx-auto max-w-6xl px-4 py-20 md:py-28">
        ...
        <div className="mt-10 grid md:grid-cols-3 gap-4">
          {projects.map((p, i) => (
            <TiltCard key={p.title} className="group rounded-xl">
              <motion.article
                ...
                whileHover={{ y: -2 }}
                className="relative rounded-xl border border-white/10 bg-white/[0.03] p-5 hover:bg-white/[0.06] transition-colors"
              >
                {/* Decorative 3D-ish gradient */}
                <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-yellow-400/0 via-yellow-400/[0.03] to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
